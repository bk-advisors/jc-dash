...
batch_config <- tibble(
  ...
  status    = c("closed", "closed", "selling", "selling", "closed")
)
...
```{r}
jc_render_batch_kpis(all_kpis[["kpis18"]], status = "selling")
```

## Per Bird

```{r}
jc_render_per_bird_kpis(all_kpis[["kpis18"]], status = "selling")
```
